...
<div class="card filter-container" >
    ...
    <div class="filter-box">
        ...
        <div class="form-check d-flex justify-content-between">
            <div><input class="form-check-input" type="radio" name="language" id="language1" value="" checked>
        ...
        <div class="form-check d-flex justify-content-between">
            <div><input class="form-check-input" type="radio" name="language" id="language<?php echo $row['s']; ?>" value="<?php echo $row['s']; ?>">
        ...
        <div class="form-check">
            <input class="form-check-input" type="radio" name="type" id="type1" value="" checked>
            <label class="form-check-label" for="type1">All Types</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="radio" name="type" id="type2" value="Theory and Code">
            <label class="form-check-label" for="type2">Theory and Code</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="radio" name="type" id="type3" value="Theory">
            <label class="form-check-label" for="type3">Theory</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="radio" name="type" id="type4" value="Code">
            <label class="form-check-label" for="type4">Code</label>
        </div>

        <h5>Level</h5>
        <div class="form-check">
            <input class="form-check-input" type="radio" name="level" id="level1" value="" checked>
            <label class="form-check-label" for="level1">All Levels</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="radio" name="level" id="level2" value="Beginner">
            <label class="form-check-label" for="level2">Beginner</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="radio" name="level" id="level3" value="Intermediate">
            <label class="form-check-label" for="level3">Intermediate</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="radio" name="level" id="level4" value="Expert">
    ...
    <div class="flex-container">
        ...
        <button class="btn btn-outline-primary btn-outline"><i class="bi bi-arrow-clockwise"></i></button>
        <span>Showing 5 results</span>
        <select name="filter-name" class="kayd-form-field">
...
?>
        ...
        <div class="card mb-3 w-100">
            ...
            <span class="badge p-3 bg-info clip-label">Beginner</span>
        </div>
                        <div class="position-absolute bottom-0 end-0 mb-2">
