...
$query = "SELECT c.*, l.title AS category FROM ".$siteprefix."courses c LEFT JOIN ".$siteprefix."languages l ON c.language=l.s WHERE c.title LIKE '%$term%' AND c.status='publish'";
...
<div class="row p-5">
<h3 class="text-bold">Search '<?php echo $term; ?>'</h3>
<p class="text-gray text-small">Showing <?php echo $search_count;?> results</p>
<?php 
$result = mysqli_query($con, $query);
